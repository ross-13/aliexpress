...
<template>
  <div :id="`ProductComponent${product.id}`" class="bg-white inline-block rounded hover:shadow-[0_0_10px_3px_rgba(0,0,0,0.15)] cursor-pointer">
    <NuxtLink :to="`/item/${product.id}`">
      <img
        class="rounded-t" :src="product.url"
      >
      <div id="ProductDetails">
        ...
        <span class="px-1 relative -top-1.5 text-[#FF6674] text-sm font-semibold"> Extra 5% off</span>
