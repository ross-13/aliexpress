...
<template>
  <div id="MainLayout" class="w-full fixed z-50">
    ...
    >
      <ul class="flex items-center justify-end text-xs text-[#333333] font-light px-2 h-10 bg-[#FAFAFA] max-w-[1200px]">
        ...
        <li class="px-3 hover:text-[#FF4646] cursor-pointer">
          <Icon size="17" name="ic:sharp-install-mobile" />
          App
        </li>
        <li
    ...
    >
      <div class="flex lf:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
        ...
        <div class="max-w-[700px] w-full md:block hidden">
          <div class="relative">
            <div class="flex items-center border-2 border-[#FF4646] rounded-md w-full">
              <input v-model="searchItem" class="w-full placeholder-gray-400 text-sm pl-3 focus:outline-none" type="text" placeholder="kitchen accessories">
              <Icon v-if="isSearching" size="25" class="mr-2" name="eos-icons:loading" />
        ...
        <NuxtLink class="flex items-center" to="/shoppingcart">
